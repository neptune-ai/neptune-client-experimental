...
class SafeProject(neptune.Project):
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.fetch_runs_table = safe_function()(self.fetch_runs_table)
        self.fetch_models_table = safe_function()(self.fetch_models_table)
